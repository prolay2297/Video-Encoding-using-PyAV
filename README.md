...
This repository contains experiments and analysis on video encoding techniques using PyAV, comparing different configurations for H.264, H.265, and AV1 codecs. The study evaluates compression efficiency, file sizes, and quality trade-offs across various encoding settings.
...
.
├── input_videos/          # Sample input videos for encoding
├── encoded_outputs/       # Encoded videos in different formats
├── scripts/               # Python scripts for encoding & analysis
│   ├── h264_encoding.py   # H.264 encoding configurations
│   ├── h265_encoding.py   # H.265 encoding configurations
│   ├── av1_encoding.py    # AV1 with golden frames
│   └── ffprobe_analysis.py # Frame-type verification
├── results/               # CSV/data files with size comparisons
└── README.md              # This file
🚀 How to Use
...
🔗 GitHub Link: https://github.com/yourusername/video-encoding-pyav
